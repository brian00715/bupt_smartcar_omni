...
float icm_gyro_z;                                     // 换算后的数据 degree/s
...
void get_icm20602_accdata(void)
{
    ...
    icm_acc_raw_x = (int16)(((uint16)dat[0] << 8 | dat[1]));
    icm_acc_raw_y = (int16)(((uint16)dat[2] << 8 | dat[3]));
    icm_acc_raw_z = (int16)(((uint16)dat[4] << 8 | dat[5]));
}
...
void get_icm20602_gyro(void)
{
    ...
    icm_gyro_raw_x = (int16)(((uint16)dat[0] << 8 | dat[1]));
    icm_gyro_raw_y = (int16)(((uint16)dat[2] << 8 | dat[3]));
    icm_gyro_raw_z = (int16)(((uint16)dat[4] << 8 | dat[5]));
}
...
void get_icm20602_accdata_spi(void)
{
    ...
    icm_acc_raw_x = (int16)(((uint16)buf.dat[0] << 8 | buf.dat[1]));
    icm_acc_raw_y = (int16)(((uint16)buf.dat[2] << 8 | buf.dat[3]));
    icm_acc_raw_z = (int16)(((uint16)buf.dat[4] << 8 | buf.dat[5]));
}
...
void get_icm20602_gyro_spi(void)
{
    ...
    icm_spi_r_reg_bytes(&buf.reg, 7);
    icm_gyro_raw_x = (int16)(((uint16)buf.dat[0] << 8 | buf.dat[1]));
    icm_gyro_raw_y = (int16)(((uint16)buf.dat[2] << 8 | buf.dat[3]));
    icm_gyro_raw_z = (int16)(((uint16)buf.dat[4] << 8 | buf.dat[5]));
}
