...
Libraries/wch_libraries/Startup/%.o: ../Libraries/wch_libraries/Startup/%.S
	@	@	riscv-none-embed-gcc -march=rv32imac -mabi=ilp32 -msmall-data-limit=8 -mno-save-restore -O1 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wunused -Wuninitialized  -g -x assembler-with-cpp -I"../Libraries/wch_libraries/Startup" -I"D:\ProgramDev\SmartcarPrograms\Smartcar_Mecanum_Master\Libraries\rtthread_libraries\bsp" -I"D:\ProgramDev\SmartcarPrograms\Smartcar_Mecanum_Master\Libraries\rtthread_libraries\libcpu" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@	@
